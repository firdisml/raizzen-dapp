...
//Page
export default function CollabNormal(props) {
      ...
      if (chainId != process.env.NEXT_PUBLIC_CHAIN_ID) {
        ...
        if (collab < price) {
          ...
          try {
            ...
            const gasLimit = await contract.estimateGas.redeemNormal(props.price);
            const gasPrice = await web3Provider.getGasPrice();

            const purchasing = await contract.redeemNormal(props.price, {
