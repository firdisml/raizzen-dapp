        ...
        <TabPanels>
          <TabPanel>
            {receivedData.length != 0 ? <div><Grid templateColumns={["repeat(1, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)"]} gap={[3, 6, 6, 6, 6]}>
              ...
              {receivedData.map((data) => <CollabItem name={data.name} price={data.price} art_contract={data.art_contract} id={data.id} art_id={data.art_id} picture={data.picture} type={data.type} date={date}/>)}
          ...
          <TabPanel>
            {receivedData.length != 0 ? <div><Grid templateColumns={["repeat(1, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)"]} gap={[3, 6, 6, 6, 6]}>
              ...
              {normal.map((data) => <CollabNormal name={data.name} price={data.price} id={data.id} picture={data.picture} type={data.type} date={date}/>)}
